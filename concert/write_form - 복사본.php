...
<body>
    ...
    <div class="wrap">
        ...
        <div class="sub_menu">
            ...
            <ul>
                <li class="current"><a href="./sub2_1.html">제품검색</a></li>
                <li><a href="./sub2_2.html">제품FAQ</a></li>
...
?>
		<div id="write_form">
			...
			<div id="write_row1"><div class="col1"> 작성자 </div><div class="col2"><?=$usernick?></div>
<?
